...
describe('Plan Gateway', () => {
  ...
  describe('save', () => {
    it('saves the plan', async () => {
      ...
      const expectedRequest = {
        ...
        UpdateExpression: `set goal = :g, customerTokens = :t, numbers = :n`,
        ExpressionAttributeValues: {
  ...
  //       firstName: 'Barry',
  //       lastName: 'Jones',
  //       customerTokens: [{ token: '123', sharedDate: '2002-01-01' }],
  ...
  //     const planGateway = new PlanGateway({ client, tableName, logger });
  ...
  //   it('does not return the plan ID if the plan has not been previously shared', async () => {
  //     let dueDate = new Date();
  //     dueDate.setDate(dueDate.getDate() + 2);
  ...
  //       firstName: 'Barry',
  //       lastName: 'Jones',
  //       customerTokens: [{ token: '123', sharedDate: null }],
  //       goal: { actions: [{ dueDate: IsoDate.parse(dueDate) }] }
  //     };
