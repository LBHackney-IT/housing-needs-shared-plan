import { acceptedCookieIsSet, userHasAcceptedCookies, setAcceptedCookie } from './acceptCookies.js';
...
describe('Accept cookies', () => {
  ...
  describe('setAcceptedCookie',()=> {
    ...
    it('sets the cookies-accepted cookie',()=> {
      ...
      expect(Cookies.set).toHaveBeenCalledWith('cookies-accepted', true, {expires: 365});
    })
  })
});
