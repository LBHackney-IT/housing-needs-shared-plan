...
/******/ 	return __webpack_require__(__webpack_require__.s = "+7gv");
/******/ })
/************************************************************************/
/******/ ({
    ...
    function handleRewrites(parsedUrl) {
      for (const rewrite of rewrites) {
        ...
        if (params) {
          ...
          if (parsedUrl.pathname === '/api/hello-world'){
            break
          }
      ...
      /* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
        try {
          ...
          const resolver = __webpack_require__("3Ykf")
          await apiResolver(
            req,
            res,
            Object.assign({}, parsedUrl.query, params ),
            resolver,
            {previewModeId:"2eec8a6dc99371c3965f4cdef1bd8aa5",previewModeSigningKey:"bf44f87bc6895571677a031f5d769389acfdb7d76b594cbeea944bff616b68dd",previewModeEncryptionKey:"474289a03938f63e8a62a2389e5283afc60185fb1081ec9c19c7c2d8208a0c13"},
