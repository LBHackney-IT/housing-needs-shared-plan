...
const LegalText = () => {
  return (
    <div data-testid="legal-text-test" className={css['legal-text']}>
      ...
      <Details title={'About the Council’s duty to you'} color={'black'}>
        This duty to prevent your homelessness will come to an end if the
        Council notifies you that it is satisfied that:
        <ul>
          <li>
            Suitable accommodation is available for your occupation and there is
            a reasonable prospect that it will continue to be available to you
            for at least six months from the date of this notice; or
          </li>
          ...
          <li>
            ...
            reasonable prospect that the accommodation would have been available
            for your occupation for a period of at least six months; or
          </li>
          <li>
            you have become homeless intentionally from any accommodation which
            the Council has made available to you as a result of our functions
            under s195; or
          </li>
          <li>you are no longer eligible for homelessness assistance; or</li>
          <li>you become homeless; or</li>
          <li>you withdraw your application for homelessness assistance; or</li>
          <li>
            ...
            unreasonably refused to undertake one or more of the actions agreed
            within your personal housing plan.
          </li>
        </ul>
      </Details>
    </div>
